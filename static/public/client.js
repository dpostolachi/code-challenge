...
exports.pushFavouriteBand = exports.loadFavouriteBands = exports.fetchBand = exports.resetBand = undefined;
...
// Reset band details
var resetBand = exports.resetBand = function resetBand() {
...
exports.default = _styledComponents2.default.button(_templateObject, function (props) {
    ...
    return props.background ? props.background : _colors.mainColor;
}, function (props) {
    return props.hoverColor ? props.hoverColor : '#ffffff';
}, function (props) {
    return props.hoverBackground ? props.hoverBackground : _colors.mainColor;
});
...
var Header = _styledComponents2.default.header(_templateObject2, _media.device.tablet);
...
var Html = _styledComponents2.default.html(_templateObject);
        ...
        value: function render() {
            ...
            return _react2.default.createElement(
                ...
                _react2.default.createElement(
                    ...
                    _react2.default.createElement('meta', { name: 'msapplication-TileColor', content: '#b91d47' }),
                ...
                _react2.default.createElement(
                    ...
                    this.props.children,
                    _react2.default.createElement('script', { dangerouslySetInnerHTML: { __html: 'window.__REDUX_STATE__ = ' + JSON.stringify(store.getState()) + ';' } }),
...
/***/ "../components/variables/colors.js":
/*!*****************************************!*\
  !*** ../components/variables/colors.js ***!
  \*****************************************/
/*! no static exports found */
...
exports.default = function (state, action) {
    ...
    switch (action.type) {
        ...
        case 'FETCH_BAND_PENDING':
            return _extends({}, state, { pending: true, fetched: false, data: null });
        ...
        case 'FETCH_BAND_FULFILLED':
            return _extends({}, state, { pending: false, fetched: true, data: action.payload });

        case 'BAND_RESET':
            return _extends({}, state, { pending: false, fetched: false, data: null });
...
exports.default = function (state, action) {
    ...
    switch (action.type) {
        ...
        case 'EVENTS_PENDING':
            return _extends({}, state, { pending: true, fetched: false, data: [] });
        ...
        case 'BAND_RESET':
            return _extends({}, state, { pending: false, fetched: false, data: [] });
...
var _search = __webpack_require__(/*! ./search */ "../reducers/search.js");
...
// Search Page
{
    ...
    component: (0, _loadableComponents2.default)(function () {
        ...
        modules: ['../components/pages/search']
    }),
    exact: true
},
// Favorite Bands Page
...
// Band Details + Band events
{
    ...
    component: (0, _loadableComponents2.default)(function () {
        return new Promise(function (resolve) {
            Promise.all(/*! require.ensure */[__webpack_require__.e(6), __webpack_require__.e(4)]).then((function (require) {
    ...
    component: (0, _loadableComponents2.default)(function () {
        return new Promise(function (resolve) {
            __webpack_require__.e(/*! require.ensure */ 5).then((function (require) {
                resolve(__webpack_require__(/*! ../components/pages/notFound */ "../components/pages/notFound.js"));
            }).bind(null, __webpack_require__)).catch(__webpack_require__.oe);
        });
    }, {
        modules: ['../components/pages/notFound']
    }),
    exact: false
}];
    ...
    return _react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            Routes.map(function (route, key) {
                return _react2.default.createElement(_reactRouter.Route, _extends({}, route, { key: key }));
            })
        )
    );
};
...
var _get = __webpack_require__(/*! ../store/get */ "../store/get.js");
...
var reduxStore = (0, _get2.default)(initialState);
...
(0, _loadableComponents.loadComponents)().then(function () {
    (0, _reactDom.hydrate)(_react2.default.createElement(
        ...
        _react2.default.createElement(
            ...
            null,
            _react2.default.createElement(_routes2.default, { store: reduxStore, loadableState: loadableState, stylesheet: null })
        )
    ), document);
});
...
module.exports = __webpack_require__(/*! /Users/dumitru/Projects/code-challenge/client/index.js */"./index.js");
